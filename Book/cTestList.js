...
)
{
  for (var i=0; i<vList.length; i++)
  {
    ...
    if (vList[i].Paused == 1) 
    {
      ...
      vList[i].Correct = vList[i].Total = vList[i].Percent = vList[i].Last = vList[i].First = vList[i].High = vList[i].Attempt = '';
      continue;
    }
...
//----------------------------------------------------------------------------------------------------
cTestList.prototype.fSetActive =
function(
  vTestId
)
{
...
//----------------------------------------------------------------------------------------------------
cTestList.prototype.fGetActive =
function(
)
{
  return this.xTestId;
...
)
{
  ...
  {
    var vTestId = vSignal.target.getAttribute('data');
